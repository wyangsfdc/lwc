...
export const isNativeShadowDefined = globalThis[KEY__IS_NATIVE_SHADOW_ROOT_DEFINED];
export const isSyntheticShadowDefined = hasOwnProperty.call(Element.prototype, KEY__SHADOW_TOKEN);
...
export function getAttribute(element: Element, name: string, namespace?: string): string | null {
    return isUndefined(namespace)
...
export function removeAttribute(element: Element, name: string, namespace?: string): void {
